...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form-items-container">
        ...
        <div class="form-item">
            <span runat="server" id="register_error_message" visible="false" class="hidden-error-message">User with this credentials already exists
            </span>
        </div>
        <div class="form-item">
            <asp:Button ID="btnRegister" runat="server" name="btnRegister" Text="Register" OnClientClick="return(validate('txtUsername', 'txtFirstName', 'txtLastName', 'txtPass', 'txtConfirmPass', 'numOfBigSets', 'numOfSmallSets', 'muscleGroup', 'workoutSplits'))" />
